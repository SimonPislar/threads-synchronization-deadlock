...
/* psem_wait(semA)
  ...
  Atomically decrements the counter of the semaphore pointed to by semA. If the
...
/* psem_signal(semA)
   ...
   Atomically increments the counter of the semaphore pointed to by semA.  If
...
/* psem_destroy(semA)
   ...
   Destroys the semaphore pointed to by semA. Only a semaphore that has been
